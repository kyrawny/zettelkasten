...
*Comparable benchmarks between neuromorphic hardware platforms is the gap in the literature that the authors are trying to fill. ([note on p.2](zotero://open-pdf/library/items/S4TD4XET?page=2))*
